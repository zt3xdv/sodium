...
function encode(decoded) {
    ...
    for (let i = 0; i < decoded.length; i++) {
        ...
        const lineMappings = [];
        for (let _i = 0, line_1 = line; _i < line_1.length; _i++) {
            const segment = line_1[_i];
...
function getLocator(source, options) {
    ...
    const originalLines = source.split('\n');
    let start = 0;
    const lineRanges = originalLines.map(function (line, i) {
        const end = start + line.length + 1;
        const range = { start: start, end: end, line: i };
        start = end;
        return range;
    });
    let i = 0;
    ...
    constructor(graph, id, options, isEntry, moduleSideEffects, syntheticNamedExports, meta) {
        ...
        this.info = {
            ...
            get importedIds() {
                ...
                return Array.from(sources, source => { let _a; return (_a = module.resolvedIds[source]) === null || _a === void 0 ? void 0 : _a.id; }).filter(Boolean);
            },
            get importers() {
                return importers.sort();
            },
...
// This file was generated. Do not modify manually!
const nonASCIIidentifierChars = "\u200c\u200d\xb7\u0300-\u036f\u0387\u0483-\u0487\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u0669\u0670\u06d6-\u06dc\u06df-\u06e4\u06e7\u06e8\u06ea-\u06ed\u06f0-\u06f9\u0711\u0730-\u074a\u07a6-\u07b0\u07c0-\u07c9\u07eb-\u07f3\u07fd\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0859-\u085b\u0898-\u089f\u08ca-\u08e1\u08e3-\u0903\u093a-\u093c\u093e-\u094f\u0951-\u0957\u0962\u0963\u0966-\u096f\u0981-\u0983\u09bc\u09be-\u09c4\u09c7\u09c8\u09cb-\u09cd\u09d7\u09e2\u09e3\u09e6-\u09ef\u09fe\u0a01-\u0a03\u0a3c\u0a3e-\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a66-\u0a71\u0a75\u0a81-\u0a83\u0abc\u0abe-\u0ac5\u0ac7-\u0ac9\u0acb-\u0acd\u0ae2\u0ae3\u0ae6-\u0aef\u0afa-\u0aff\u0b01-\u0b03\u0b3c\u0b3e-\u0b44\u0b47\u0b48\u0b4b-\u0b4d\u0b55-\u0b57\u0b62\u0b63\u0b66-\u0b6f\u0b82\u0bbe-\u0bc2\u0bc6-\u0bc8\u0bca-\u0bcd\u0bd7\u0be6-\u0bef\u0c00-\u0c04\u0c3c\u0c3e-\u0c44\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0c66-\u0c6f\u0c81-\u0c83\u0cbc\u0cbe-\u0cc4\u0cc6-\u0cc8\u0cca-\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0ce6-\u0cef\u0d00-\u0d03\u0d3b\u0d3c\u0d3e-\u0d44\u0d46-\u0d48\u0d4a-\u0d4d\u0d57\u0d62\u0d63\u0d66-\u0d6f\u0d81-\u0d83\u0dca\u0dcf-\u0dd4\u0dd6\u0dd8-\u0ddf\u0de6-\u0def\u0df2\u0df3\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0e50-\u0e59\u0eb1\u0eb4-\u0ebc\u0ec8-\u0ecd\u0ed0-\u0ed9\u0f18\u0f19\u0f20-\u0f29\u0f35\u0f37\u0f39\u0f3e\u0f3f\u0f71-\u0f84\u0f86\u0f87\u0f8d-\u0f97\u0f99-\u0fbc\u0fc6\u102b-\u103e\u1040-\u1049\u1056-\u1059\u105e-\u1060\u1062-\u1064\u1067-\u106d\u1071-\u1074\u1082-\u108d\u108f-\u109d\u135d-\u135f\u1369-\u1371\u1712-\u1715\u1732-\u1734\u1752\u1753\u1772\u1773\u17b4-\u17d3\u17dd\u17e0-\u17e9\u180b-\u180d\u180f-\u1819\u18a9\u1920-\u192b\u1930-\u193b\u1946-\u194f\u19d0-\u19da\u1a17-\u1a1b\u1a55-\u1a5e\u1a60-\u1a7c\u1a7f-\u1a89\u1a90-\u1a99\u1ab0-\u1abd\u1abf-\u1ace\u1b00-\u1b04\u1b34-\u1b44\u1b50-\u1b59\u1b6b-\u1b73\u1b80-\u1b82\u1ba1-\u1bad\u1bb0-\u1bb9\u1be6-\u1bf3\u1c24-\u1c37\u1c40-\u1c49\u1c50-\u1c59\u1cd0-\u1cd2\u1cd4-\u1ce8\u1ced\u1cf4\u1cf7-\u1cf9\u1dc0-\u1dff\u203f\u2040\u2054\u20d0-\u20dc\u20e1\u20e5-\u20f0\u2cef-\u2cf1\u2d7f\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua620-\ua629\ua66f\ua674-\ua67d\ua69e\ua69f\ua6f0\ua6f1\ua802\ua806\ua80b\ua823-\ua827\ua82c\ua880\ua881\ua8b4-\ua8c5\ua8d0-\ua8d9\ua8e0-\ua8f1\ua8ff-\ua909\ua926-\ua92d\ua947-\ua953\ua980-\ua983\ua9b3-\ua9c0\ua9d0-\ua9d9\ua9e5\ua9f0-\ua9f9\uaa29-\uaa36\uaa43\uaa4c\uaa4d\uaa50-\uaa59\uaa7b-\uaa7d\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uaaeb-\uaaef\uaaf5\uaaf6\uabe3-\uabea\uabec\uabed\uabf0-\uabf9\ufb1e\ufe00-\ufe0f\ufe20-\ufe2f\ufe33\ufe34\ufe4d-\ufe4f\uff10-\uff19\uff3f";
...
const TokenType = function TokenType(label, conf) {
  if ( conf === void 0 ) {conf = {};}
...
const hasOwn = Object.hasOwn || (function (obj, propName) { return (
  hasOwnProperty.call(obj, propName)
); });

const isArray = Array.isArray || (function (obj) { return (
...
const Position = function Position(line, col) {
  this.line = line;
  this.column = col;
};
...
const SourceLocation = function SourceLocation(p, start, end) {
  this.start = start;
  this.end = end;
...
prototypeAccessors.allowSuper.get = function () {
  const ref = this.currentThisScope();
    const flags = ref.flags;
    const inClassFieldInit = ref.inClassFieldInit;
...
const DestructuringErrors = function DestructuringErrors() {
...
pp$8.parseTopLevel = function(node) {
  ...
  if (this.inModule)
    { for (let i = 0, list = Object.keys(this.undefinedExports); i < list.length; i += 1)
      {
        const name = list[i];
...
pp$8.parseForStatement = function(node) {
  ...
  const init = this.parseExpression(awaitAt > -1 ? "await" : true, refDestructuringErrors);
...
pp$8.parseLabeledStatement = function(node, maybeName, expr, context) {
  for (let i$1 = 0, list = this.labels; i$1 < list.length; i$1 += 1)
    {
...
pp$8.exitClassBody = function() {
  const ref = this.privateNameStack.pop();
...
pp$8.checkPatternExport = function(exports, pat) {
  ...
  if (type === "Identifier")
    ...
    { for (let i = 0, list = pat.properties; i < list.length; i += 1)
      {
        const prop = list[i];
...
pp$8.checkVariableExport = function(exports, decls) {
  if (!exports) { return; }
  for (let i = 0, list = decls; i < list.length; i += 1)
    {
    const decl = list[i];
...
pp$7.checkLValPattern = function(expr, bindingType, checkClashes) {
  ...
  switch (expr.type) {
  case "ObjectPattern":
    for (let i = 0, list = expr.properties; i < list.length; i += 1) {
      const prop = list[i];
...
const TokContext = function TokContext(token, isExpr, preserveSpace, override, generator) {
  this.token = token;
  this.isExpr = !!isExpr;
...
pp$5.parseSubscripts = function(base, startPos, startLoc, noCalls, forInit) {
  const maybeAsyncArrow = this.options.ecmaVersion >= 8 && base.type === "Identifier" && base.name === "async" &&
...
pp$5.parseNew = function() {
  ...
  const startPos = this.start, startLoc = this.startLoc, isImport = this.type === types$1._import;
...
pp$5.parseTemplate = function(ref) {
  if ( ref === void 0 ) {ref = {};}
  let isTagged = ref.isTagged; if ( isTagged === void 0 ) {isTagged = false;}

  const node = this.startNode();
  this.next();
  node.expressions = [];
  let curElt = this.parseTemplateElement({isTagged: isTagged});
  node.quasis = [curElt];
  while (!curElt.tail) {
...
const Scope = function Scope(flags) {
  this.flags = flags;
...
pp$3.declareName = function(name, bindingType, pos) {
  ...
  if (bindingType === BIND_LEXICAL) {
    ...
    for (let i = this.scopeStack.length - 1; i >= 0; --i) {
      const scope$3 = this.scopeStack[i];
...
const Node = function Node(parser, pos, loc) {
  this.type = "";
  this.start = pos;
  this.end = 0;
...
for (let i = 0, list = [9, 10, 11, 12, 13]; i < list.length; i += 1) {
...
const RegExpValidationState = function RegExpValidationState(parser) {
  this.parser = parser;
...
pp$1.regexp_pattern = function(state) {
  ...
  for (let i = 0, list = state.backReferenceNames; i < list.length; i += 1) {
    const name = list[i];
...
class ModuleLoader {
    ...
    async addModuleSource(id, importer, module) {
        ...
        let source;
        try {
            source = await this.graph.fileOperationQueue.run(async () => { let _a; return (_a = (await this.pluginDriver.hookFirst('load', [id]))) !== null && _a !== void 0 ? _a : (await promises.readFile(id, 'utf8')); });
        }
        catch (err) {
...
const getCache = (config) => { let _a; return ((_a = config.cache) === null || _a === void 0 ? void 0 : _a.cache) || config.cache; };
...
const getModuleContext = (config, context) => {
    ...
    if (typeof configModuleContext === 'function') {
        return id => { let _a; return (_a = configModuleContext(id)) !== null && _a !== void 0 ? _a : context; };
    }
...
const getMinifyInternalExports = (config, format, compact) => { let _a; return (_a = config.minifyInternalExports) !== null && _a !== void 0 ? _a : (compact || format === 'es' || format === 'system'); };
