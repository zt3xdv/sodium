...
function mergeInputOptions(config, overrides, defaultOnWarnHandler) {
    const getOption = (name) => { let _a; return (_a = overrides[name]) !== null && _a !== void 0 ? _a : config[name]; };
    const inputOptions = {
...
const readdirp_1 = readdirp$1;

const anymatch$2 = {exports: {}};
...
const normalizePath$2 = function(path, stripTrailing) {
...
const pathPosixDirname = require$$0$2.posix.dirname;
...
const binaryExtensions$1 = {exports: {}};
...
const isBinaryPath$1 = filePath => extensions.has(path.extname(filePath).slice(1).toLowerCase());
...
const nodefsHandler = NodeFsHandler$1;
